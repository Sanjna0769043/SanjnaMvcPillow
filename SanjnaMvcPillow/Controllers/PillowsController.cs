...
namespace SanjnaMvcPillow.Controllers
{
    ...
    {
        private readonly SanjnaMvcPillowContext _context;

        public PillowsController(SanjnaMvcPillowContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
         ...
         public async Task<IActionResult> Index(string searchString)  //Add a Search option to find desire records
{
    ...
    {
        pillows = pillows.Where(s => s.ProductName.Contains(searchString));
    }
    ...
    return View(await pillows.ToListAsync());
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductName,Material,size,Color,Price,Rating")] Pillow pillow)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProductName,Material,size,Color,Price,Rating")] Pillow pillow)
        {
            if (id != pillow.Id)
            {
                return NotFound();
